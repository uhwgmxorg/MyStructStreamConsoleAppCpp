========================================================================
    KONSOLENANWENDUNG: MyStructStreamConsoleAppCpp-Projektübersicht
========================================================================

Diese MyStructStreamConsoleAppCpp-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre MyStructStreamConsoleAppCpp-Anwendung besteht.


MyStructStreamConsoleAppCpp.vcxproj
...
MyStructStreamConsoleAppCpp.vcxproj.filters
...
MyStructStreamConsoleAppCpp.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen MyStructStreamConsoleAppCpp.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
